    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(h2, "class", "svelte-140ww0e");
    			add_location(h2, file$1, 18, 2, 246);
    			add_location(input0, file$1, 19, 2, 283);
    			add_location(input1, file$1, 20, 2, 295);
    			attr_dev(div, "class", "form svelte-140ww0e");
    			add_location(div, file$1, 17, 0, 225);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
