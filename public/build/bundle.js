...
var app = (function () {
    ...
    /* src/components/Nested.svelte generated by Svelte v3.20.1 */
    ...
    function create_default_slot_1(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(36:4) <Route path=\\\"/register\\\">",
    		ctx
    	});
    ...
    function create_fragment$7(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(button, file$5, 41, 4, 752);
    			add_location(div, file$5, 40, 2, 742);
    			attr_dev(main, "class", "svelte-1oin0ko");
    			add_location(main, file$5, 30, 0, 572);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		m: function mount(target, anchor, remount) {
    			...
    			current = true;
    			if (remount) dispose();
    			dispose = listen_dev(button, "click", incrementCounter, false, false, false);
    		},
    		p: function update(ctx, [dirty]) {
    			const router_changes = {};
